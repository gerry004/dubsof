...
const APPROACH = [
  ...
  },
  {
    ...
    description:
      "We'll develop a detailed roadmap aligned with your operational goals and budget, and subsequently build a long term, phased proposal.",
  },
  {
  ...
  {
    title: "Lean Business Growth",
    description:
      "Longterm, the requirement to increase headcount is vastly reduced.",
  },
];
        ...
        scrollTrigger: {
          ...
          onUpdate: (self) => {
            ...
            if (progress >= startPosition && progress <= endPosition) {
              const itemProgress =
                (progress - startPosition) / (endPosition - startPosition);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 transform transition-all duration-700 opacity-0 animate-fadeIn">
          ...
          <p className="text-center text-lg text-white max-w-3xl mx-auto">
            We're not just a software company—we're problem solvers and
            efficiency experts. Our process begins with understanding your
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <h3 className="text-xl font-bold mb-3 text-warm-orange">
                      {item.title}
                    </h3>
