    ...
    <div className="flex flex-col items-center max-w-3xl w-full px-4 space-y-6">
      ...
      <div className="w-full bg-black/40 backdrop-blur-sm rounded-lg border border-orange-500/30 p-6 shadow-lg">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-orange-400 text-2xl font-bold mb-2">Eliminating Wasteful Admin Hours</h3>
      ...
      <div className="w-full bg-black/40 backdrop-blur-sm rounded-lg border border-orange-500/30 p-6 shadow-lg">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-orange-400 text-2xl font-bold mb-2">Fragmented, Inefficient Systems</h3>
